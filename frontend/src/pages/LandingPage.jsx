    ...
    return (
        <div className="landing-page">
            <style>{`
                ...
                .landing-nav-brand svg { color: var(--accent); }
                .landing-nav-actions { display: flex; gap: 1.5rem; align-items: center; }
                .landing-nav-link {
                    background: none;
                    border: none;
                    font-size: 0.88rem;
                ...
                .landing-nav-cta::before, .landing-nav-cta::after {
                    content: '';
                    position: absolute;
                    top: 50%;
                ...
                .landing-nav-cta::before { left: -5px; }
                .landing-nav-cta::after { right: -5px; }
                ...
                .landing-btn-ghost:hover { border-color: var(--accent); }
                ...
                .landing-building::before {
                    ...
                    background: repeating-linear-gradient(
                        45deg, var(--landing-awning, var(--accent)) 0 8px,
                        var(--surface) 8px 16px
                    );
                }
                .landing-building .door {
                    position: absolute;
                    bottom: 0; left: 50%;
                ...
                .landing-building-one { width: 84px; height: 130px; background: var(--surface); transform: rotate(-1.5deg); }
                .landing-building-one .window { top: 40px; left: 14px; }
                .landing-building-one .window:nth-child(3) { left: 50px; }
                .landing-building-two { width: 100px; height: 170px; background: var(--surface); --landing-awning: var(--gold); transform: rotate(1deg); z-index: 1; }
                .landing-building-two .window { top: 34px; left: 16px; }
                .landing-building-two .window:nth-child(3) { left: 62px; }
                .landing-building-two .window:nth-child(4) { top: 64px; left: 16px; }
                .landing-building-two .window:nth-child(5) { top: 64px; left: 62px; }
                .landing-building-three { width: 84px; height: 110px; background: var(--surface); --landing-awning: var(--success); transform: rotate(-0.5deg); }
                .landing-building-three .window { top: 40px; left: 14px; }
                .landing-building-three .window:nth-child(3) { left: 50px; }
                .landing-building-star {
                    position: absolute;
                    top: -14px; left: 50%;
                    transform: translateX(-50%);
                    color: var(--gold);
                    animation: landing-star-bob 2.6s ease-in-out infinite;
                }
                @keyframes landing-star-bob {
                    0%, 100% { transform: translateX(-50%) translateY(0); }
                    50% { transform: translateX(-50%) translateY(-4px); }
                }
                @media (prefers-reduced-motion: reduce) {
                    .landing-building-star { animation: none; }
                }
                ...
                @keyframes landing-cursor-blink { 50% { opacity: 0; } }
                ...
                .landing-ticker-name { color: #E6ECF4; font-weight: 600; }
                .landing-ticker-city { color: #7C8AA0; font-size: 0.78rem; }
                .landing-ticker-rating {
                    font-family: var(--font-mono);
                    color: #E7B95C;
                    font-weight: 500;
                }
                .landing-ticker-divider { color: #3A4A5E; }
                ...
                .landing-section-head { margin-bottom: 2.75rem; max-width: 480px; }
                ...
                .landing-section-head p { color: var(--text-2); font-size: 0.98rem; margin: 0; }
                ...
                .landing-bento-card.large { grid-row: 1 / 3; display: flex; flex-direction: column; justify-content: center; }
                .landing-bento-icon {
                ...
                .landing-bento-card p { font-size: 0.87rem; color: var(--text-2); line-height: 1.55; margin: 0 0 1rem; }
                .landing-bento-list { list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.5rem; }
                .landing-bento-list li { display: flex; align-items: center; gap: 0.5rem; font-size: 0.82rem; color: var(--text-2); }
                .landing-bento-list svg { color: var(--accent); flex-shrink: 0; }

                /* ---------- CTA: stamp ---------- */
                .landing-cta-wrap { max-width: 1200px; margin: 0 auto; padding: 0 3rem 5rem; }
                .landing-cta {
                    background: var(--ink);
                    border-radius: var(--radius);
                ...
                .landing-cta p { color: #B7C2D0; margin: 0; font-size: 0.92rem; }
                .landing-cta-btn {
                    position: relative;
                    background: #E7B95C;
                    color: var(--ink);
                ...
                .landing-cta-btn::before, .landing-cta-btn::after {
                    content: '';
                    position: absolute;
                    top: 50%;
                    width: 10px; height: 10px;
                ...
                .landing-cta-btn::before { left: -5px; }
                .landing-cta-btn::after { right: -5px; }
                ...
                @media (max-width: 860px) {
                    .landing-hero { grid-template-columns: 1fr; padding: 2.5rem 1.5rem 2.5rem; }
                    .landing-hero h1 { font-size: 2.4rem; }
                    .landing-nav { padding: 1.25rem 1.5rem; }
                    .landing-section { padding: 3rem 1.5rem; }
                    .landing-bento { grid-template-columns: 1fr; grid-template-rows: none; }
                    .landing-bento-card.large { grid-row: auto; }
                    .landing-cta { padding: 2rem; flex-direction: column; text-align: center; }
                    .landing-cta-wrap { padding: 0 1.5rem 3.5rem; }
                }
            `}</style>
            ...
            <header className="landing-hero">
                ...
                <div>
                    <div className="landing-storefronts">
                        <div className="landing-building landing-building-one">
                            <span className="window" />
                            <span className="window" />
                            <span className="door" />
                        </div>
                        <div className="landing-building landing-building-two">
                            <IconStar filled width={16} height={16} className="landing-building-star" />
                            <span className="window" />
                            <span className="window" />
                            <span className="window" />
                            <span className="window" />
                        ...
                        <div className="landing-building landing-building-three">
                            <span className="window" />
                            <span className="window" />
                            <span className="door" />
                        </div>
                ...
                <div className="landing-ticker-track">
                    {[...TICKER_ITEMS, ...TICKER_ITEMS].map((s, i) => (
                        <div className="landing-ticker-item" key={i}>
                            ...
                            <span className="landing-ticker-city">{s.city}</span>
                            <span className="landing-ticker-rating">★ {s.rating}</span>
                            <span className="landing-ticker-divider">/</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <section className="landing-section">
                ...
                <div className="landing-bento">
                    <div className="landing-bento-card large">
                        <div className="landing-bento-icon" style={{ background: 'var(--accent-tint)', color: 'var(--accent-dark)' }}>
                            <IconUsers width={20} height={20} />
                        </div>
                        <h3>For Users</h3>
                        <p>Search stores by name or address, and rate the ones you visit.</p>
                        <ul className="landing-bento-list">
                    ...
                    <div className="landing-bento-card">
                        <div className="landing-bento-icon" style={{ background: 'var(--gold-tint)', color: 'var(--gold)' }}>
                    ...
                    <div className="landing-bento-card">
                        <div className="landing-bento-icon" style={{ background: 'var(--success-tint)', color: 'var(--success)' }}>
